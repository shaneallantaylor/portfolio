...
$('.sample-1').click(function(e){
  ...
  if ($(e.target).is('a')) {
    ...
    if (!$(".sample-1").hasClass("active")) {
      ...
      $(".sample-3").addClass("unfocused");
      $(".sample-4").addClass("unfocused");
      ...
      $(".sample-3").removeClass("unfocused");
      $(".sample-4").removeClass("unfocused");
...
$('.sample-3').click(function(e){
  if ($(e.target).is('a')) {
  }
  else {
    if (!$(".sample-3").hasClass("active")) {
      console.log("sample-3 doesn't have the active class");
      $(".sample-3").addClass("active");
      $(".sample-2").addClass("unfocused");
      $(".sample-1").addClass("unfocused");
      $(".sample-4").addClass("unfocused");
      $('.sample-3 .sample-title').css("height", "80px");
      $('.sample-3 p').css("bottom", "10px");
      $('.sample-title-3').css("margin-bottom", "4px")
      $('.expo-container').removeClass("nope");
      $('.arrow-up.right').removeClass("nope");
      $('.expo-text.3').removeClass("hidden");
      $('.expo-text.3').removeClass("nope");
    }
    else {
      console.log("sample-2 DOES have the active class");
      $(".sample-3").removeClass("active");
      $(".sample-2").removeClass("unfocused");
      $(".sample-1").removeClass("unfocused");
      $(".sample-4").removeClass("unfocused");
      $('.sample-3 .sample-title').css("height", "50px");
      $('.sample-3 p').css("bottom", "0px");
      $('.sample-title-3').css("margin-bottom", "8px")
      $('.expo-container').addClass("nope");
      $('.arrow-up.right').addClass("nope");
      $('.expo-text.3').addClass("nope");
      $('.expo-text.3').addClass("hidden");
    }
  }
});

$('.sample-4').click(function(e){
  if ($(e.target).is('a')) {
  }
  else {
    if (!$(".sample-4").hasClass("active")) {
      console.log("sample-4 doesn't have the active class");
      $(".sample-4").addClass("active");
      $(".sample-3").addClass("unfocused");
      $(".sample-2").addClass("unfocused");
      $(".sample-1").addClass("unfocused");
      $('.sample-4 .sample-title').css("height", "80px");
      $('.sample-4 p').css("bottom", "10px");
      $('.sample-title-4').css("margin-bottom", "4px")
      $('.expo-container').removeClass("nope");
      $('.arrow-up.right').removeClass("nope");
      $('.expo-text.4').removeClass("hidden");
      $('.expo-text.4').removeClass("nope");
    }
    else {
      console.log("sample-2 DOES have the active class");
      $(".sample-4").removeClass("active");
      $(".sample-3").removeClass("unfocused");
      $(".sample-2").removeClass("unfocused");
      $(".sample-1").removeClass("unfocused");
      $('.sample-4 .sample-title').css("height", "50px");
      $('.sample-4 p').css("bottom", "0px");
      $('.sample-title-4').css("margin-bottom", "8px")
      $('.expo-container').addClass("nope");
      $('.arrow-up.right').addClass("nope");
      $('.expo-text.4').addClass("nope");
      $('.expo-text.4').addClass("hidden");
    }
  }
});
